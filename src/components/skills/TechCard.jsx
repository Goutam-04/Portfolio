...
const TechCard = ({ title, classaName, tech }) => {
  return (
    <div className="flex-1 flex flex-col gap-4 bg-cardPrimary p-2 md:p-4 rounded-md hover:shadow-xl bg-[#132a43] ">
      <div className="text-primary-t text-center font-medium text-xs lg:text-lg tracking-wider">
        {title}
      </div>
      <div className="flex flex-wrap gap-2 justify-center items-center ">
        {tech.map((item, i) => (
          <div
            key={i}
            className={cn(
              'rounded-md bg-body text-xs text-primary-t p-1.5 md:p-2',
              ...
              item === 'React-Router' && 'border border-pink-500/60',
              ...
              item === 'Razorpay' && 'border border-sky-500/60',
              item === 'NPM package' && 'border border-red-600/60',
              item === 'MongoDB' && 'border border-emerald-500/60',
              item === 'Mongoose' && 'border border-green-500/60',
              item === 'MySQL' && 'border border-black/60',
